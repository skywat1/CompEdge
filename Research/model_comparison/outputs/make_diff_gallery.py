...
Usage (from this outputs/ dir, with the repo venv):
...
REPO_ROOT = HERE.parents[2]  # outputs/ -> model_comparison/ -> Research/ -> repo
...
def main():
    ...
    ap.add_argument("--parquet-dir", type=Path, default=HERE / "parquet")
